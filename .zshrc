...
# DISABLED by tballard 2026-06-30: this added the "FORGE  gpt-5.4..." RPROMPT segment.
# Re-running `forge zsh setup` will restore these lines.
# if [[ -z "$_FORGE_THEME_LOADED" ]]; then
#     eval "$(forge zsh theme)"
# fi
# <<< forge initialize <<<

# Belt-and-suspenders: clear any forge RPROMPT even if the managed block above
# gets regenerated by `forge zsh setup`. Remove this line if you re-enable the theme.
RPROMPT=''
